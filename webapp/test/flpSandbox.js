		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#empsmartfilterempodatasmartfilterproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"empsmartfilterempodatasmartfilterproject-display": {
								"semanticObject": "empsmartfilterempodatasmartfilterproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=empsmartfilter.empodatasmartfilterproject",
									"url": sap.ui.require.toUrl("empsmartfilter/empodatasmartfilterproject")
								}
							}
						}
					}
